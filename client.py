...
from core.mateclasses import ClientMaker
            ...
            with sock_lock:
                try:
                    ...
                    if ACTION in message and message[ACTION] == MESSAGE and SENDER in message and DESTINATION \
                            in message and MESSAGE_TEXT in message and message[DESTINATION] == self.account_name:
...
def main():
    ...
    try:
        ...
        user_interface = ClientSender(client_name, sock, database)
